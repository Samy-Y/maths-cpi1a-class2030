...
\begin{exercise}
    ...
    \begin{outline}
        ...
        \1 On pose $\forall P \in E, P = \sum_{k=1} a_k X^k$ (le terme constant est nul car $P(0) = 0$), alors $f(P) = \sum_{k=1} a_k ((X+1)^k - X^k)$.
...
\begin{consequence}
    Si $f$ est un projecteur, alors $\forall k \le 1, f^k = f$.
\end{consequence}
...
\begin{exercise}
    ...
    \begin{itemize}
        ...
        \item $f \in \mathcal L(E)$ est un projecteur $\iff$ $E = \Imf(f) \oplus \Ker(f)$.
    \end{itemize}
\end{exercise}
\todo{17/04 FAIRE URGENT}
