...
\begin{example}
    ...
    \begin{itemize}
        ...
        \item $U_{\Z/n\Z} = \{\overline{a} \in \Z/n\Z \tq \exists \overline{b} \in \Z/n\Z, \overline{a} \dot\times \overline{b} = \overline{1}\}$\\$=\{\overline{a} \in \Z/n\Z \tq \pgcd (a,n) = 1\}$ (en utilisant le théorème de Bézout).\\Par exemple, $U_{\Z/9\Z} = \{\overline{1}, \overline{2}, \overline{4}, \overline{5}, \overline{7}, \overline{8}\}$.
...
\begin{remark}[Hors programme]
    ...
    $$\varphi(n) = \card{U_{\Z/n\Z}} = \card{\{k\in[\![1,n]\!] \tq \pgcd(k,n) = 1\}}$$
