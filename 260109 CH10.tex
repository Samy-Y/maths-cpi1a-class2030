...
\begin{remark}[Hors programme]
    Le cardinal de $\Uset_{\Z/n\Z}$ \textbf{ne divise pas $n$}, parce que $U_{\Z/n\Z}$ n'est pas un sous-groupe de $(\Z/n\Z,+)$ (les deux lois sont différentes). Par exemple, pour $n=8$, on a $\card{U_{\Z/8\Z}}=4$ qui ne divise pas $8$. Le cardinal du groupe $(\Z/n\Z,\times)$ est donné par la fonction indicatrice d'Euler $\varphi(n)$.
