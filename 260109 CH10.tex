...
\begin{remark}[Notation $\Uset$]
    Le symbole $\Uset$ vient de l'``unité'', car les éléments inversibles sont aussi appelés ``unités''. On note très souvent $\Uset$ l'ensemble des éléments inversibles d'un anneau.
\end{remark}
