...
% ===========================
% IL FAUT REMPLACER LES PGCD
% LEUR STYLE A ETE CHANGE DANS LE FICHIER elegant-cours.sty
% ===========================
...
\MaPageDeGarde{Chapitre X : Structures algébriques}{Rédigé par Samy Youssoufine}{./assets/logo.png}{Document Incomplet. Peut contenir des erreurs/sections incomplètes.}
...
\begin{example}
    Dans $(\Z,+,\times)$, on a $2\Z + 3\Z = n\Z$, où $n = \pgcd 23 = 1$ (voir chapitre suivant).
