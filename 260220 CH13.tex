...
\begin{theorem}[D.E.S. d'une fraction rationnelle]
    Soit $F = \frac AB \in \Kset(X)$ avec $\deg(F) < 0$ et $A\wedge B = 1$ et $B$ unitaire.
...
\begin{proof}
    ...
    $$\frac{R}{\prod_{i=1}^r B_i^{\alpha_i}} = \sum_{i=1}^r \frac{A_{i,1}}{B_i}$$
...
$F = \frac AB \in \Kset(X) \avec A \wedge B = 1$ et $B = (X-a)^5 \cdot Q$ avec $Q(a) \neq 0$ et $a \in \Kset$.
