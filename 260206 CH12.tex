...
\begin{attention}
    Un polynôme irréductible \textbf{n'est pas} forcément un polynôme qui n'admet pas de racines dans $\Kset$. Par exemple $(X^2+1)^2$ est un polynôme réductible dans $\R[X]$, mais il n'admet pas de racines dans $\R$. Idem pour le polynôme $X^4+1$ dans $\R[X]$, qui est réductible mais n'admet pas de racines dans $\R$.
\end{attention}
