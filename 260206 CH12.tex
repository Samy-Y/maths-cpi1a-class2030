...
\begin{theorem}
    ...
    \begin{outline}[enumerate]
        \1 \textbf{PGCD :}
        \2 $\exists ! D \in \Kset[X]$ avec $\begin{cases}D \text{ unitaire }\\D= 0\end{cases}$ tel que :\\ $\sum_{i=1}^{n}P_i \Kset[X] = D\cdot\Kset[X]$ et $\forall i \in [\![1,n]\!], D \mid P_i$.
        ...
        \1 \textbf{PPCM :}
        \2 $\exists ! M \in \Kset[X]$ avec $\begin{cases}M \text{ unitaire }\\M= 0\end{cases}$ tel que :\\ $\bigcap_{i=1}^{n} P_i \cdot \Kset[X] = M\cdot\Kset[X]$ et $\forall i \in [\![1,n]\!], P_i \mid M$.
