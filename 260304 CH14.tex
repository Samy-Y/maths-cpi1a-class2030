...
\begin{property}
    Soient $V_1,\dots,V_p \in E$, alors $\rang(V_1,\dots,V_p) \le p$, avec égalité si et seulement si $(V_1,\dots,V_p)$ est une famille libre de $E$, i.e. $\rang(V_1,\dots,V_p) = p \iff (V_1,\dots,V_p) \text{ est une famille libre de } E$.
\end{property}
