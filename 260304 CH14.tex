...
\MaPageDeGarde{Chapitre XIV-A : Algèbre Linéaire}{Retranscrit par Samy Youssoufine}{./assets/logo.png}{WIP. Peut contenir des erreurs ou des sections incomplètes.}
...
\begin{theorem}[Lemme]
    Tout sous-espace vectoriel $R$ d'un $\Kset$-ev. de dimension finie $E$ admet un supplémentaire dans $E$, c'est à dire que :
