...
\todo{preuve pas du tout rigoureuse en dessous}
...
\begin{proof}
  ...
  \begin{itemize}
    ...
    \item On pose $\varphi_a : \begin{cases} I\setminus\{a\}\to\R \\ t\mapsto \frac{f(t)-f(a)}{t-a} \end{cases}$.
    \item On sait que $\varphi_a$ est croissante.
